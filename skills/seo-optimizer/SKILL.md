...
<!--
  Source:   https://github.com/davila7/claude-code-templates/tree/main/cli-tool/components/skills/business-marketing/seo-optimizer
  Author:   Daniel (San) Ávila — Copyright (c) 2025
  License:  MIT — see ./LICENSE
  Pinned:   upstream main as of 2026-05-14 (commit f35152e3462244dd0a78c0053add998a1bb7697c)
  Notes:    Unmodified copy. Frontmatter `name` changed from "SEO Optimizer" to kebab-case "seo-optimizer" for plugin namespace compatibility (Claude Code requires kebab-case skill names).
-->
